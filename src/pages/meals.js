...
<section id="Projects"
    ...
    <div class="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="#">
            <img src="https://img.freepik.com/premium-photo/delicious-buddha-bowl-with-grilled-chicken_338779-1589.jpg?w=740"
    ...
    <div class="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="#">
            <img src="https://img.freepik.com/free-photo/fresh-fruit-berry-salad-healthy-eating_114579-20466.jpg?t=st=1713352213~exp=1713355813~hmac=1889346437c4b27a950c82f083c86348c94bfa9e8e3bff154e732a693e986e16&w=740"
                    alt="Product" class="h-80 w-72 object-cover rounded-t-xl" />
            <div class="px-4 py-3 w-72">
    ...
    <div class="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="#">
            <img src="https://jollofhutdxb.com/wp-content/uploads/2023/06/6F89C53B-189B-4C54-88AD-6308463FAF1A.jpeg"
                    alt="Product" class="h-80 w-72 object-cover rounded-t-xl" />
            <div class="px-4 py-3 w-72">
